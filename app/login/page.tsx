    ...
    <div className="min-h-screen bg-[#1a1a1a] flex flex-col items-center justify-center p-8">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-100 mb-2">Welcome to Spiral</h1>
          <p className="text-gray-400">Sign in to start writing with AI</p>
        </div>
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#262626] hover:bg-[#333] border border-[#333] rounded-lg text-gray-200 font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
